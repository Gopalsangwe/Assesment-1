...
import { calculateCommission } from './services/commissionService.ts';
...
function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Take only the total values from backend
      setResults({
        avalphaTechnologiesCommission: result.avalphaTotal,
        competitorCommission: result.competitorTotal
      });
    } catch (error) {
      console.error('Error calculating commission:', error);
      alert('Failed to calculate commission. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="results-grid">
              ...
              <div className="result-card avalpha-card">
                ...
                <div className="result-amount">
                  £{results.avalphaTechnologiesCommission.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                </div>
              </div>
              ...
              <div className="result-card competitor-card">
                ...
                <div className="result-amount">
                  £{results.competitorCommission.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                </div>
              </div>
            </div>
            ...
            {results.avalphaTechnologiesCommission > 0 && (
              <div className="advantage-indicator">
                <p className="advantage-text">
                  ...
                  <strong>
                    {' '}
                    £{(results.avalphaTechnologiesCommission - results.competitorCommission).toLocaleString(undefined, {
